# Generated by Django 3.1.1 on 2021-04-04 12:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='KashTransaction',
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('note', models.TextField()),
                ('group_mode', models.CharField(blank=True, choices=[('normal', 'Normal'), ('pacha', 'Pacha'), ('faro', 'Faro')], max_length=10)),
                ...
                ('total', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='XOF', max_digits=17)),
                ('initiator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='kash_transactions', to='kash.userprofile')),
                ('recipients', models.ManyToManyField(related_name='kash_received', to='kash.UserProfile')),
            ],
            options={
                'abstract': False,
            },
