# Generated by Django 3.1.1 on 2021-04-03 14:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.CharField(default='rave', max_length=255)),
                ('nickname', models.CharField(max_length=255)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kash.profile')),
            ],
            options={
                'abstract': False,
            },
