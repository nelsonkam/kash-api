...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='checkout',
            name='shipping_fees',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default_currency='XOF', max_digits=14, null=True),
        ),
        migrations.AddField(
            model_name='checkout',
            name='shipping_fees_currency',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='core.shippingprofile'),
        ),
    ]
