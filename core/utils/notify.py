...
from kash.utils import GATEWAY_LIST, Gateway
...
def parse_command(data):
    ...
    try:
        ...
        if chat_id != settings.TG_CHAT_ID:
            tg_bot.send_message(
                chat_id=chat_id, text="You do not have the necessary permissions to communicate with Jarvis.")
            return
