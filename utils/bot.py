...
def post_metrics():
    ...
    slack_message = [
        {
            ...
            "text": "",
            "fields": [
                {"title": "Active This Week", "value": active_users, "short": True},
                {"title": "Active Last Week", "value": last_week_users, "short": True},
    ...
    return slack.send_message(
        slack_message, "#metrics" if config.APP_ENV == "production" else "#dev-test"
    )
