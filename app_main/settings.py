...
environ.Env.read_env(env_file=str(BASE_DIR / ".env.prod"))
...
NK_RAVE_SECRET_KEY = env("NK_RAVE_SECRET_KEY")
RAVE_PUBLIC_KEY = env("RAVE_PUBLIC_KEY")
NK_RAVE_PUBLIC_KEY = env("NK_RAVE_PUBLIC_KEY")
...
CONVERSION_RATES = {"NGN_XOF": 630 / 580, "MARGIN": 0.1}
